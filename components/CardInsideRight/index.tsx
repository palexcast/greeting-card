            ...
            <div className={styles.container}>
                ...
                <div className={styles.textContainer}>
                    ...
                    <div className={styles.textMiddle}>
                        <span className={styles.text + ' ' + styles.larger}>We would like to invite you to this year's digital Christmas Party.</span>
                        <span
                            className={styles.text + ' ' + styles.larger}>An evening filled with fun and laughter!</span>
                        <span className={styles.text}>Dress code: Dress to impress!</span>
                        ...
                        <span className={styles.importantText}>
                            ...
                            <span className={styles.text}>Our wish is that you enjoy this surprise alongside your colleagues on the 17th. </span>
                        </span>
                    </div>
                </div>
            </div>
